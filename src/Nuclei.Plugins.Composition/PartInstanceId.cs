...
namespace Nuclei.Plugins.Instantiation
{
    ...
    {
        /// <summary>
        /// Defines the ID number for an invalid part instance ID.
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static readonly Guid _invalidId = new Guid("{9C5C17FA-53A1-44C2-AB65-2F155D249081}");
